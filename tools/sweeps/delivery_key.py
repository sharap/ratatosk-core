...
WHOLE_MESSAGE = {
    ...
    "on_clear_chat",
    # Человек отписался от канала (фаза 2, §10.6). Сильнее очистки: чат
    # исчезает целиком вместе с ключами чтения, и «все копии» здесь —
    # ровно то, что нужно. Уехать после удаления они всё равно не смогут:
    # собирать их нечем.
    "on_unsubscribe_from_channel",
}
