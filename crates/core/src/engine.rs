...
///
/// Здесь только «куда слать этому ключу»: ни имени, ни сверки, ни
/// карточки. Владелец канала, узнанный из ссылки (§10.1), — сегодня
/// единственный его вид; рой (§7) сядет сюда же.
#[derive(Debug, Clone)]
pub struct Peer {
    ...
    /// Почему мы его знаем — `ratatosk_store::PEER_CHANNEL_OWNER` и далее.
    pub known_as: u32,
}
