// Сид пишется мнемоникой, а не байтовыми четвёрками: `0x0_A19` читается
// как «A19» и по нему находится сценарий, уронивший проверку. Дополни
// его нулями до `0x0000_0A19` — и смысл пропадёт, а clippy требует ровно
// этого. Правило про группировку цифр придумано для масок и адресов;
// здесь число — имя, а не величина.
